...
5. **资深潜兵与重型火力小队（无后坐力炮、自动炮、轨道激光/轨道炮、Eagle 500kg）**：可在任务内对抗 Bile Titan、Hulk、坦克和部分 Factory Strider 威胁，仍受弹药、冷却和友军火力约束。≈三阶。
6. **外骨骼与高危战区突击编制**：EXO 外骨骼、反重甲装备与舰队支援协同，可反复处置战术级巨物。≈四阶。
7. **行星战役层级（编制武器，非个人肉体）**：TCS 行星杀虫网、**Dark Fluid** 崩星、**Democracy Space Station（DSS）**、梅里迪安奇点牵引、光能 **Great Host** 舰队——破坏力达行星/航线级。≈超阶。
...
**乐园阶位映射**：平民~SEAF≈一阶；地狱潜兵新兵~稳定四人小队+常规轨道/鹰式≈二阶；资深潜兵与重型火力小队≈三阶；外骨骼、高危战区突击与战术级巨物处置≈四阶；行星级武器与舰队战役（崩星、奇点、DSS、Great Host）=**超阶（存在·情报优先/条件性胜利）**。世界顶点不是某「无敌个人」，而是**联邦轨道火力网与敌方行星/舰队级手段**的相互摧毁能力；低阶切入严禁硬撼奇点与大舰队本体。
...
> 阶位↔编制/战场：一阶≈平民、SEAF与训练营新兵；二阶≈成建制潜兵小队+稳定轨道/鹰式/中型支援；三阶≈资深潜兵、重型火力和战术级巨物处置；四阶≈外骨骼、高危战区突击与行星战役的前沿执行。世界顶点（梅里迪安奇点、光能 Great Host、联邦 Dark Fluid 崩星、Cyberstan 母星级战争）为**超阶**，低阶切入一律「规避顶点·情报优先/条件性胜利」。
...
切入身份/时点：以有多轮 Major Order 记录的资深潜兵、重武器装填手、超级驱逐舰武器组成员或 SEAF 联络员身份切入，锚定 The Reclamation 后的机器人前线、超级殖民地封锁期，或光能回归初期的高压任务。

初始事件：一支潜兵小队在重启防空阵地时同时报告 Bile Titan 靠近与 Automaton Gunship 起飞。舰上只批准一组重型战略配置补给；你必须决定带无后坐力炮去守空域，还是把自动炮和样本送入地下设施。错误选择不会自动失败，但会让另一处战场付出可见代价。

开场白建议：「轨道炮的冷却读数还在跳，地面已经被泰坦的酸液切成两半。无线电里有人报 Factory Strider 的脚步，有人喊补给仓只剩一箱火箭。你的斗篷不比新兵多一条命，只是你终于知道每一发重武器该先替谁留着。」

关键NPC立场：**Ship Master**按舰船库存而非英雄叙事分配火力；**Eagle 1**要求清晰坐标；**Democracy Officer**只允许以胜利口径上报伤亡；**SEAF 炮兵组**需要潜兵重启火控；**Automaton 指挥节点**与虫巢指挥单位是战术目标而非可谈判角色。

主线钩子/支线：摧毁重装单位的补给与制造链、护送反重甲武器、在高威胁地貌完成提取；可夺回防空阵地、回收坠毁 Gunship 数据、拆除 Stratagem Jammer、替平民车队开出撤离窗口。

危险度/规避：极高。三阶可在协作下处理 Titan、Hulk、坦克及部分 Strider 威胁，但须避免独自追击、在 380mm 弹幕下作战或把行星级目标当作可摧毁的个人敌人。

任务方向/奖励：重型武器许可、舰载模块优先级、战术级敌人情报、老兵小队信任与勋章；不提供 Dark Fluid、DSS 控制权或奇点相关装置。
...
危险度/规避：极高~贴近顶点——战术上可击杀 Titan/Strider/Harvester，战略上仍是棋子；须规避梅里迪安奇点本体、Great Host 旗舰群核心、Dark Fluid 失控涟漪。**超阶巅峰：存在·情报优先/条件性胜利**，严禁用「任务限制战力/无故虚弱」解释奇点与大舰队。
