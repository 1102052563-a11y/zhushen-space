/**
 * Batch 489-500 leisure world generator (scenario-archive style).
...
const BATCHES = {
  489: ["淫魔劇団-舞台稽古", "女騎士レオナ-永久服従", "触手遊園地-夜間営業", "催眠塾-冬期講習", "エルフ貿易港-税関検査"],
  490: ["魔界拍卖所-希少品競売", "人妻堕落-自治会副会長", "淫獣研究所-第五期計画", "触手博物館-学芸員", "女教師調教-春休み"],
  491: ["聖騎士団-第五次再建失敗", "催眠温泉-露天風呂", "エルフ双子姫-第四世代", "魔法少女堕落-多元宇宙進出", "人妻温泉-系列化完了"],
  492: ["淫魔帝国-時空征服", "触手世界-全次元統一", "魔導図書館-司書長", "催眠劇場-千秋楽", "エルフ温泉街-観光協会"],
  493: ["触手養殖場-新種開発", "人妻派遣-海外事業部", "魔法少女ユウナ-教団拡大", "聖女孤児院-卒業式", "淫魔企業-株主総会"],
  494: ["女騎士エリカ-完全奴隷化", "触手遊園地-新アトラクション", "催眠塾-夏期講習", "エルフ貿易港-輸入品検査", "魔界拍卖所-定期競売"],
  495: ["人妻堕落-自治会会長就任", "淫獣研究所-量産体制確立", "触手博物館-特別企画展", "女教師調教-GW集中", "聖騎士団-歴史博物館拡張"],
  496: ["催眠温泉-岩盤浴", "エルフ双子姫-帝国統一", "魔法少女堕落-宇宙帝国建設", "人妻温泉-国際連盟発足", "淫魔帝国-全銀河統一"],
  497: ["触手世界-永恒支配確立", "魔導騎士団-再建中", "催眠占い館-新規開店", "エルフ薬師-新薬開発", "触手植物園-温室拡張"],
  498: ["人妻料理教室-上級クラス", "魔法少女サクヤ-二重人格", "聖女巡礼-最終試練", "淫魔郵便局-国際便", "女騎士エミリア-十度目覚醒"],
  499: ["触手映画館-オールナイト", "催眠写真館-卒業アルバム", "エルフ歌劇団-海外公演", "魔界喫茶-常連客", "人妻ジム-24時間営業"],
  500: ["淫獣サーカス-世界巡業", "触手ビーチ-海水浴シーズン", "女教師温泉-年度慰安", "聖騎士団-第六次復活計画", "催眠書店-読書サークル"],
};
...
const DLSITE_LINKS = {
  ...
  museum: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E5%8D%9A%E7%89%A9%E9%A4%A8/order/trend/from/fs.header",
  sauna: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E3%82%B5%E3%82%A6%E3%83%8A/order/trend/from/fs.header",
  conveni: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E3%82%B3%E3%83%B3%E3%83%93%E3%83%8B/order/trend/from/fs.header",
  idol: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E3%82%A2%E3%82%A4%E3%83%89%E3%83%AB/order/trend/from/fs.header",
  zoo: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E5%8B%95%E7%89%A9%E5%9C%92/order/trend/from/fs.header",
  aqua: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E6%B0%B4%E6%97%8F%E9%A4%A8/order/trend/from/fs.header",
  mine: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E9%89%B1%E5%B1%B1/order/trend/from/fs.header",
  space: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E5%AE%87%E5%AE%99/order/trend/from/fs.header",
  bar: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E9%85%92%E5%A0%B4/order/trend/from/fs.header",
  yukan: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E9%81%8A%E9%83%AD/order/trend/from/fs.header",
  volleyball: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E3%83%90%E3%83%AC%E3%83%BC/order/trend/from/fs.header",
  massage: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E3%83%9E%E3%83%83%E3%82%B5%E3%83%BC%E3%82%B8/order/trend/from/fs.header",
  academy: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E5%AD%A6%E5%9C%92/order/trend/from/fs.header",
  island: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E5%AD%A4%E5%B3%B6/order/trend/from/fs.header",
  forest: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E6%A3%AE%E6%9E%97/order/trend/from/fs.header",
  fish: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E9%A4%8A%E9%AD%9A/order/trend/from/fs.header",
  dispatch: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E6%B4%BE%E9%81%A3/order/trend/from/fs.header",
  orphan: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E5%AD%A4%E5%85%90%E9%99%A2/order/trend/from/fs.header",
  artmuse: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E7%BE%8E%E8%A1%93%E9%A4%A8/order/trend/from/fs.header",
  shrine2: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E5%AE%AE%E5%8F%B8/order/trend/from/fs.header",
  pta: "https://www.dlsite.com/maniax/fsr/=/language/jp/sex_category%5B0%5D/male/keyword/%E4%BA%BA%E5%A6%BB/order/trend/from/fs.header",
};
...
/** Per-focus flavor so 60 worlds don't share the same facility skeleton */
function focusFlavor(name, focus, main, seed) {
  const f = focus + main;
  const rooms = {
    舞台稽古: ["稽古場A", "楽屋B", "袖幕裏"],
    永久服従: ["誓約書庫", "甲冑整備室", "中庭回廊"],
    夜間営業: ["夜間入口", "軟触観覧車", "閉園後広場"],
    冬期講習: ["冬期教室", "自習室B", "塾長室"],
    税関検査: ["検査レーン", "保税倉庫", "通関控室"],
    希少品競売: ["競売ホール", "鑑定控室", "落札後茶室"],
    自治会副会長: ["自治会室", "回覧板コーナー", "町内会倉庫"],
    第五期計画: ["第五期ラボ", "倫理委員会室", "観察ログ室"],
    学芸員: ["収蔵庫", "展示準備室", "学芸員デスク"],
    春休み: ["職員室", "空き教室", "屋上倉庫"],
    第五次再建失敗: ["再建会議室", "史料庫", "旧団旗保管"],
    露天風呂: ["露天風呂", "脱衣所", "湯上がり縁側"],
    第四世代: ["月桂宮側殿", "双子控えの間", "継承儀礼場"],
    多元宇宙進出: ["互助会会議室", "旧変身室", "跨界联络所"],
    系列化完了: ["本館大浴場", "系列説明室", "女将控え"],
    時空征服: ["时空企划室", "夜游营业部", "股东茶室"],
    全次元統一: ["次元联络台", "软触温室", "统一宣言厅"],
    司書長: ["禁書廊", "司書長室", "閲覧席B"],
    千秋楽: ["本公演舞台", "千秋楽楽屋", "花道袖"],
    観光協会: ["協会事務室", "温泉街案内所", "共同湯前"],
    新種開発: ["養殖池A", "新品種観察室", "餌料庫"],
    海外事業部: ["海外事業部", "渡航前研修室", "時差休息室"],
    教団拡大: ["教団事務所", "説法小間", "信者控室"],
    卒業式: ["礼拝堂", "卒業控室", "孤児院中庭"],
    株主総会: ["総会ホール", "株主控室", "夜游ラウンジ"],
    完全奴隷化: ["誓約書庫", "甲冑室", "反省回廊"],
    新アトラクション: ["新アトラクション試乗口", "設計室", "夜間整備庫"],
    夏期講習: ["夏期教室", "冷房自習室", "補習控室"],
    輸入品検査: ["輸入レーン", "検疫室", "通関茶室"],
    定期競売: ["定期ホール", "目録室", "落札後談話"],
    自治会会長就任: ["会長室", "就任式会场", "回覧板棚"],
    量産体制確立: ["量産ライン見学廊", "品質会議室", "休息ラウンジ"],
    特別企画展: ["企画展ホール", "図録室", "夜間設営場"],
    GW集中: ["GW講習室", "職員仮眠室", "屋上"],
    歴史博物館拡張: ["拡張工区", "史料修復室", "旧団旗展"],
    岩盤浴: ["岩盤浴室", "クールダウン室", "ミネラルバー"],
    帝国統一: ["統一儀礼殿", "双子並座", "月桂庭"],
    宇宙帝国建設: ["生活重建企划室", "旧披风库", "星見台"],
    国際連盟発足: ["連盟事務局", "国際湯治棟", "通訳控室"],
    全銀河統一: ["銀河企划室", "夜游支店联络", "祝杯ラウンジ"],
    永恒支配確立: ["支配儀礼台", "软触议会", "永恒温室"],
    再建中: ["再建工房", "骑士文书室", "临时营帐"],
    新規開店: ["占い個室", "開店準備室", "待合ソファ"],
    新薬開発: ["薬草温室", "調剤台", "臨床観察室"],
    温室拡張: ["拡張温室", "植物日誌室", "ミスト回廊"],
    上級クラス: ["上級厨房", "試食テーブル", "レシピ庫"],
    二重人格: ["変身控室", "双面日誌室", "互助会茶室"],
    最終試練: ["巡礼終着堂", "試練控室", "圣泉缘侧"],
    国際便: ["国際便窓口", "夜班仕分室", "切手茶室"],
    十度目覚醒: ["覚醒記録室", "甲冑整備", "十度目の鏡"],
    オールナイト: ["深夜上映室", "売店裏", "映写室"],
    卒業アルバム: ["撮影ブース", "暗室", "アルバム編集室"],
    海外公演: ["海外公演楽屋", "通訳控", "舞台袖"],
    常連客: ["常連席", "カウンター裏", "夜の個室"],
    二十四時間営業: ["24hフロア", "ロッカー室", "夜間スタッフルーム"],
    "24時間営業": ["24hフロア", "ロッカー室", "夜間スタッフルーム"],
    世界巡業: ["巡業テント", "楽屋車", "開幕前広場"],
    海水浴シーズン: ["ビーチハウス", "監視台下", "夕陽デッキ"],
    年度慰安: ["慰安宿", "大浴場", "宴会座敷"],
    第六次復活計画: ["復活計画室", "史料庫", "旧団旗修復"],
    読書サークル: ["サークル室", "朗読席", "禁書棚角"],
  };
  // fallback by keyword fragments
  let trio = rooms[focus];
  if (!trio) {
    const keys = Object.keys(rooms);
    const hit = keys.find((k) => focus.includes(k) || k.includes(focus.slice(0, 2)));
    trio = rooms[hit] || ["主ホール", "控室B", "裏方通路"];
  }
  const rituals = [
    `「${focus}」当日必须双人清点名册，漏一人就重开点名`,
    `与「${main}」相关的道具只许本周主题色标签`,
    `焦点词「${focus}」出现在门口灯箱时，全员改用轻声`,
    `本周禁止把「${focus}」写成口号——只写成可完成的一件小事`,
    `收尾时在签到本写一句「今天与${focus}有关的我做到了___」`,
  ];
  const r0 = pick(seed + "fl0", rituals, 0);
  const r1 = pick(seed + "fl1", rituals, 1);
  return {
    roomA: trio[0],
    roomB: trio[1],
    roomC: trio[2],
...
function buildWorld(name, batch) {
  ...
  const fl = focusFlavor(name, focus, main, seed);
...
世界的「温度」来自三处：一是设施内暖光与白噪音，时间比外面慢半拍；二是固定座位／床位与「习惯道具」——谁总选同一香型、谁总要额外毯子；三是角色在家庭／职场之外被认真称呼名字时，那种被看见的微小幸福。治愈感不靠奇迹，靠重复：每两周一次的会期、同一句「先问状态再开始」、同一杯课后${props[2]}。${microA.join("；")}。`;
  ...
  const pGeo = `- **${facility}本馆**：${loc.station}步行数分钟的二层空间。一楼前台与鞋柜、主题区「${fl.roomA}」／私密区「${fl.roomB}」、缓冲「${fl.roomC}」、茶水角、储物角与小型露台。玻璃门贴「${focus}・少人数・可拒否」。
- **${fl.roomA}**：初诊、团体课、公开示范与「${focus}」主流程；呼吸交叠是升温主舞台。
- **${fl.roomB}**：「${secret}」与加钟多发生于此；适合慢热告白与「说不」的练习。
- **${fl.roomC}／茶水角**：加班崩溃与和好常在这里；排课表与「${focus}」备忘贴在冰箱门上。
...
每个场景的情感功能：初遇＝被塞进「${focus}」空位的体验；升温＝固定时段续约；冲突＝家庭日程与营业撞车、或被邻居看见共伞；和解＝雨天加开一场修复课；告白＝关店后只剩一盏灯与未收的${props[0]}。本条专属标语写在更衣室镜角：${fl.slogan}。`;
...
最适合切入：产假交接后的入职第一周，欢迎${props[0]}尚温时。契约者是情感变数，不是外来支配者。`;
  ...
  const pad = `
**${focus}专属流程备忘（本世界独有）**
1. 开场：前台核名 → 禁忌三问（过敏／疲劳／「今天可不可以碰」）→ 选 ${fl.roomA}／${fl.roomB}。  
2. 中段：正规流程进行到一半，允许一次「暂停重来」而不扣费——这是${c0.given}立下的店规。  
3. 收尾：${props[2]}、${props[0]}归还、预约本只写自愿的下一格。  
4. ${focus}特别项：${fl.ritualA}；遗失一件相关道具，当晚全员留下复盘，不罚钱只谈「谁在慌」。  
5. 外派日：跟${c1.given}走合作路线时，禁止把店内黑话带到外场；违者由${c0.given}亲自停班一周（情感上等于冷处理）。  
6. 雨天预案：${props[1]}关闭时改走${fl.roomC}长谈；共伞只送到站口，不送进玄关。  
7. 月末复盘会：每人说一句「这周我被谁记住了」——比业绩数字更重要；并追加一句与「${focus}」相关的小事。  
8. 新人满月礼：见习满四周，${c0.given}会送一支只写名字的${props[0]}；丢了可以再要，但她会记得你丢过。  
9. 本周焦点纪律：${fl.ritualB}。  
10. 标语复习：${fl.slogan}——说不出口的人，今晚只准做收尾，不准带示范。
...
切入身份：${facility}${roles.helper}（可兼前台），或${focus}体验新会员。中立名分可进出 ${fl.roomA}／${fl.roomB}、${fl.roomC}与${props[1]}，不被立刻拖入越界菜单，又足够被当成值得信任的「手」。${c1.given}线可从外派日以「临时搭档」合流。
...
日常玩法钩子：  
1. **预约站队线**：连续为谁加钟／谁用 ${fl.roomB}，改变座位与流言；三连加钟≈流言订婚。  
2. **问诊本线**：自愿／拒绝代写禁忌，影响 True／BE；强行越界触发${c0.given}拒客。  
3. **${fl.roomC}线**：跟${c4.given}关店听壁脚，获取真心话。  
4. **${props[1]}散步线**：每晚可约一人，触发关键事件。  
5. **外派线**：跟${c1.given}一日，解锁 HE／Bittersweet。  
6. **${secret}／${focus}菜单线**：只有双方同意才可写入；学会说「可以停」锚定结局走廊。  
7. **${focus}焦点作业线**：本周至少完成一次与「${focus}」直接相关的共同作业，否则好感停在礼貌层。
