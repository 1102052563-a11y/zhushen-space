...
const dir = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..', '产出', '批次481');
...
console.log('cross-file cast dups:', cross.length ? cross : 'none');
console.log('unique cast names:', Object.keys(map).length);
