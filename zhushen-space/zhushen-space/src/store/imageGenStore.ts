...
- <prompt>：英文 NAI tags，开头写主体数量与性别——**性别严格按上方「在场角色完整外观资料」里标注的来写（女=1girl、男=1boy、futanari 等），严禁凭外观/发型/服装/气质/职业猜测性别，绝不可把女性画成男性或反之**；随后角色外貌/发型发色/眼睛/服装/体态/动作表情/场景/光影；NSFW 等级≥mild 时按等级加入对应裸露/行为 tags，忠实正文、不凭空添加。
