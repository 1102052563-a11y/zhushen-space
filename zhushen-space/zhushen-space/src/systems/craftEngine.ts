...
export const CRAFT_MODES: CraftMode[] = [
  ...
  {
    id: 'alchemy', icon: '⚗', name: '炼金', blurb: '草药·矿物·精华 → 药剂·丹药·转化物',
    inputHint: '草药 / 矿物 / 精华 / 兽血 / 灵液',
    prefCats: ['材料', '消耗品'], outCategory: '消耗品', outHint: '药剂 / 丹药 / 转化产物（恢复 / 增益 / 解毒等消耗品）',
    minInputs: 1,
    cotFocus: '药材与矿物的配比、相性能否嬗变成药，有无相冲相克；提纯火候过猛则出废渣/毒物。',
    wbSeed: '炼金 药剂 丹药 草药 矿物 精华 嬗变 提纯 相性 恢复',
  },
  {
    id: 'talisman', icon: '📜', name: '技能卷轴', blurb: '材料 → 消耗型技能卷轴',
    inputHint: '卷轴 / 符纸 / 灵墨 / 技能结晶 / 本源碎片',
    prefCats: ['材料', '消耗品'], outCategory: '消耗品', outHint: '消耗型技能卷轴（使用即施放一次卷内技能，用后消耗）',
    minInputs: 1,
    cotFocus: '要封入的技能与承载媒介能否契合、能量够不够撑起一次施放；卷成后是几次性、威力几何。',
    wbSeed: '卷轴 技能卷轴 符箓 施放 技能 一次性 消耗 本源',
  },
  {
  ...
  {
    id: 'artifice', icon: '⚙', name: '主神造物', blurb: '材料 → 乐园装置·傀儡·召唤道具',
    inputHint: '合金 / 能源核心 / 芯片 / 纳米材料 / 模块',
    prefCats: ['材料', '工具'], outCategory: '工具', outHint: '主神空间造物：装置 / 傀儡 / 无人机 / 义体组件 / 召唤道具',
    minInputs: 1,
    cotFocus: '结构与供能是否自洽、能源核心够不够驱动；造物功能由芯片/模块/零件合理推导——走主神空间科技风，别掺修仙炼器味。',
    wbSeed: '主神 乐园 造物 装置 傀儡 无人机 能源核心 芯片 纳米 模块 召唤 科技',
  },
  {
    id: 'tame', icon: '🐾', name: '宠物', blurb: '材料 + 精魂 → 宠物随从（直接收服）',
