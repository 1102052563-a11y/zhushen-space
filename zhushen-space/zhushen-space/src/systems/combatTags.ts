...
export const TAG_REGISTRY: Record<CombatTag, TagDef> = {
  ...
  poison:     { tag: 'poison',     label: '中毒',   emoji: '🧪', kind: 'debuff',   tone: 'debuff',  uses: ['stacks'],                desc: '每回合损失=层数×毒性(按施毒者攻击力档3%折算) HP，然后层数−1', tier: 0 },
  ...
  thorns:     { tag: 'thorns',     label: '荆棘',   emoji: '🌵', kind: 'buff',     tone: 'buff',    uses: ['stacks', 'turns'],       desc: '受到攻击时反弹伤害给攻击者（层数×攻击力档4%折算为定值）', tier: 1 },
  regen:      { tag: 'regen',      label: '再生',   emoji: '♻️', kind: 'heal',     tone: 'buff',    uses: ['stacks', 'turns'],       desc: '每回合回复=层数×攻击力档 5% 的 HP', tier: 1 },
  burn:       { tag: 'burn',       label: '燃烧',   emoji: '🔥', kind: 'debuff',   tone: 'debuff',  uses: ['flat', 'turns'],         desc: '每回合损失 flat HP，持续 turns 回合（flat 缺省/过小时按施放者攻击力档12%兜底）', tier: 1 },
