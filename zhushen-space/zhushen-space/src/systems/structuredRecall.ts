...
export function serializePlayerCard(
  ...
  const hpBase = withAttrDelta(withAttrDelta(withAttrDelta(a, playerTreeAttrBonus('B1')), playerTeamAttrBonus()), profile.realAttrs);   // +真实属性点直加(realAttrs)：AI 看到的血量与面板/战斗同尺度
