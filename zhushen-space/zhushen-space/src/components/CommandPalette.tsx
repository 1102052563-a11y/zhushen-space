...
const ALIAS: Record<string, string> = {
  ...
  '深渊': 'shenyuan sy abyss dungeon', '幽冥': 'youming ym shenyuan abyss dungeon 深渊',   // 五阶前封印期的显示名，同一面板
  '回合洞察': 'huihedongcha hhdc insight', '任务': 'renwu rw quest task',
  '参谋': 'canmou cm advisor 顾问 商量 提案 出主意 加任务 埋伏笔 记节日',
  '坐标': 'zuobiao zb bookmark 收藏 书签 标记 名场面 收藏夹 楼层',
  // P4·⌘K 深动作（不在右侧导航、只从命令面板直达的二级功能）
  '装备强化': 'zhuangbeiqianghua qh enhance forge 强化 强化所',
  '技能升级': 'jinengshengji jnsj upgrade skillup 升级 熔炉 融合',
  '竞技场': 'jingjichang jjc arena 排位',
  '赌场': 'duchang dc casino 赌坊 扭蛋 魂赌',
  '欢愉宫': 'huanyugong hyg joy',
  '系统商店': 'xitongshangdian xtsd shop store 商店 主神商店 买 卖',
  '结算任务': 'jiesuanrenwu jsrw settle 结算 世界结算',
  '重算变量': 'chongsuanbianliang csbl revar reroll 重roll 重新计算',
